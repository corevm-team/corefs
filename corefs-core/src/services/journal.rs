...
pub fn reconcile_persisted_state(
    state: &mut crate::storage::persisted_state::PersistedState,
) -> JournalRepairSummary {
    ...
    let mut next_active: Vec<Inode> = Vec::new();
    ...
    let mut restored: Vec<Inode> = Vec::new();
...
fn dedupe_inodes_by_path(
    mut inodes: alloc::vec::Vec<crate::domain::inode::Inode>,
) -> alloc::vec::Vec<crate::domain::inode::Inode> {
